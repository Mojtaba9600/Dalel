...
import 'package:dalel/features/home/presention/views/home.dart';
...
final GoRouter router = GoRouter(
  routes: [
    ...
    GoRoute(
      path: "/SignIn",
      builder: (context, state) =>
          BlocProvider(create: (context) => AuthCubit(), child: const SignIn()),
    ),
    GoRoute(path: "/HomePage", builder: (context, state) => const Home()),
  ],
);
